...
java -jar Raptor-Client-1.0-SNAPSHOT-jar-with-dependencies.jar --master --stage=initial --id=0 --cmd="src/test/resources/testCompilationProject/8cc/make_test.sh"
