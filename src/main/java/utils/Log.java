...
public class Log {
     ...
     * remove all "if (utils.Log.info) ..." type statements below the set level. */
    ...
    /** Performs the actual logging. Default implementation logs to SystemOps.out. Extended and use {@link Log#logger} set to handle
     * logging differently. */
    static public class Logger {
        ...
        /** Prints the message to SystemOps.out. Called by the default implementation of {@link #log(int, String, String, Throwable)}. */
